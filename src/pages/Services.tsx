...
const services = [
  {
    ...
    features: ["Custom ICP targeting by industry, title, revenue & geo", "Human-verified leads with 0% bounce guarantee", "CRM-ready CSV mapped to your exact fields", "B2B prospect research on demand"],
  ...
  },
  {
    ...
    features: ["C-suite & VP-level contact identification", "Verified email + direct dial for every profile", "LinkedIn lead generation for SaaS specialists", "Outreach-ready within 48–72 hours"],
  ...
  },
  {
    ...
    features: ["Multi-layer email verification (SMTP, MX, catch-all)", "Append missing fields: title, company, phone, LinkedIn", "Remove duplicates, invalids & role-based addresses", "Domain reputation risk scoring included"],
        ...
        <div className="container max-w-5xl space-y-8">
          {services.map((service, i) => (
            <ScrollReveal key={service.title} delay={i * 0.1}>
              <article className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8 md:p-10 hover:border-primary/40 transition-colors">
