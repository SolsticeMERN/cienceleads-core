...
const LeadGenForSaaS = () => {
  usePageSEO(
    "B2B Lead Generation for SaaS Companies | CienceLeads",
    "Human-verified SaaS leads targeting VPs, CTOs, and decision-makers. Custom prospect lists filtered by tech stack, funding stage, and company size."
  );
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 md:py-20">
        <div className="container max-w-4xl">
          ...
          <ScrollReveal delay={0.1}>
            <ConversionCTA
              headline="Get 50 Free Sample Leads — Matched to Your SaaS ICP"
              description="Tell us your ideal customer profile and we'll deliver a free sample list within 48 hours. No contracts, no commitment — just see the quality for yourself."
          ...
          <ScrollReveal delay={0.15}>
            <ConversionCTA
              variant="final"
              headline="Ready to Fill Your SaaS Pipeline?"
              description="Join 200+ SaaS companies getting human-verified leads that actually convert. Your first sample list is free."
            />
          </ScrollReveal>
        </div>
      </section>
