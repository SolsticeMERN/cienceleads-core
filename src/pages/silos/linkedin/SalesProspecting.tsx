    ...
    <main className="min-h-screen bg-background text-foreground">
      <article className="py-16 md:py-24">
        <div className="container max-w-4xl">
          ...
          {/* Breadcrumb */}
          <Link to="/linkedin-prospecting" className="inline-flex items-center gap-2 text-sm text-muted-foreground <Link to="/linkedin-prospecting" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors mb-4">="/linkedin-prospecting" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors mb-4">">
