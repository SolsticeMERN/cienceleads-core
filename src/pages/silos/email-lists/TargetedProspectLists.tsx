...
const TargetedProspectLists = () => {
  usePageSEO(
    ...
    "Targeted prospect lists matched to your ICP. Filter by industry, title, company size, revenue, and geography. Human-verified, 0% bounce."
  );
  useFAQSchema(faqs);
    ...
    <main className="min-h-screen bg-background text-foreground">
      <article className="py-16 md:py-24">
        <div className="container max-w-4xl">
          ...
          {/* Breadcrumb */}
          <Link to="/email-lists" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors mb-4">
