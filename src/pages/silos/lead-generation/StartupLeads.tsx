import { ArrowRight, Rocket, Check, Zap, TrendingUp, Target } from "lucide-react";
...
const StartupLeads = () => {
  usePageSEO(
    ...
    "Startup lead generation service built for early-stage and growth-stage B2B startups. Affordable, verified leads to fill your pipeline fast."
  );
        ...
        <div className="container max-w-4xl">
          ...
          <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8 md:p-10 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: Zap, title: "Fast Turnaround", desc: "Get your first batch of verified leads within 48-72 hours. Start outreach this week." },
                { icon: TrendingUp, title: "Flexible Scaling", desc: "Start with 200 leads, scale to 2,000+. No minimums, no long-term contracts." },
                { icon: Target, title: "ICP-Matched", desc: "We target your exact buyer persona — not generic lists from a shared database." },
              ].map((s) => (
          ...
          <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8 md:p-10 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {["No setup fees or onboarding charges", "Month-to-month — cancel anytime", "Pay per lead, not per seat", "Starter packages from 200 leads", "0% bounce guarantee included", "Free sample list before commitment", "Dedicated account manager included", "Volume discounts as you scale"].map((item) => (
          ...
          <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8 md:p-10 mb-12">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              ...
              <Link to="/proof/startup-lead-growth" className="flex items-center gap-2 text-sm text-primary hover:underline"><ArrowRight className="w-3.5 h-3.5" /> Startup Case Study</Link>
